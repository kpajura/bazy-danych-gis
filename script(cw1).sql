...
ADD CONSTRAINT "firma.godziny_pk" PRIMARY KEY (id_godziny);
...
add CONSTRAINT "firma.pensja_pk" PRIMARY KEY (id_pensji);
...
add CONSTRAINT "firma.pracownicy_pk" PRIMARY KEY (id_pracownika);
...
add CONSTRAINT "firma.premia_pk" PRIMARY KEY (id_premii);
...
add CONSTRAINT "firma.wynagrodzenie_pk" PRIMARY KEY (id_wynagrodzenia);
...
insert into firma.pensja (stanowisko, kwota) values ('ksiêgowy', '3000');
insert into firma.pensja (stanowisko, kwota) values ('programer', '10000');
insert into firma.pensja (stanowisko, kwota) values ('prawnik', '800');
insert into firma.pensja (stanowisko, kwota) values ('kierownik', '7000');
insert into firma.pensja (stanowisko, kwota) values ('developer', '900');
insert into firma.pensja (stanowisko, kwota) values ('kadry', '1500');
insert into firma.pensja (stanowisko, kwota) values ('produkcja', '900');
insert into firma.pensja (stanowisko, kwota) values ('asystent', '3500');
insert into firma.pensja (stanowisko, kwota) values ('recepcja', '700');
insert into firma.pensja (stanowisko, kwota) values ('tester', '7000');


insert into firma.premia (rodzaj, kwota) values ('nadgodziny +5', '100');
insert into firma.premia (rodzaj, kwota) values ('nadgodziny +10', '200');
insert into firma.premia (rodzaj, kwota) values ('nagodziny +15', '300');
insert into firma.premia (rodzaj, kwota) values ('nadgodziny +20', '400');
insert into firma.premia (rodzaj, kwota) values ('nadgodziny +25', '500');
insert into firma.premia (rodzaj, kwota) values ('nadgodziny +30', '600');
insert into firma.premia (rodzaj, kwota) values ('nadgodziny +35', '700');
insert into firma.premia (rodzaj, kwota) values ('nadgodziny +40', '800');
insert into firma.premia (rodzaj, kwota) values ('bonus', '1000');
...
values ('2020-02-01', '1', '2', '10', '1');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '2', '5', '1', '2');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '3', '10', '2', '3');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '4', '3', '3', '4');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '5', '2', '4', '5');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '6', '7', '2', '6');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '7', '7', '10', '7');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '8', '9', '4', '8');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '9', '1', '10', '9');
insert into firma.wynagrodzenie ("data", id_pracownika, id_pensji, id_premii, id_godziny)
values ('2020-01-01', '10', '3', '10', '10');
...
select w.id_pracownika, pen.kwota as "pensja", pre.kwota as "premia" from firma.wynagrodzenie w join firma.pensja pen on pen.id_pensji = w.id_pensji 
...
update firma.pracownicy set tel = concat(substring(tel,1, 8), '-', substring(tel, 9, 3), substring(tel, 10, 3)); 
